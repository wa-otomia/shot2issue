...
- 音声「クレーム」：話したクレームを録音し、サブスクリプションで文字起こしして、AI が文字起こしと
...
**「クレーム」。**「クレーム」ボタンはダイアログを開き、クレームを**入力**するか**録音して口述**できます
...
はシステム通知で表示されます。タイトル用プロンプトと同様、クレーム用のシステムプロンプトも設定で
...
- AI アシスタントは接続するまで無効です。「AI タイトル」を使用すると、種類、説明、ページ URL、
  ...
  「クレーム」ではさらに録音した音声が文字起こしのために送信されます。その
